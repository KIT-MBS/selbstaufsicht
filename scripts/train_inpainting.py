...
print('model')
model = models.self_supervised.MSAModel(num_layers, num_heads, d_head, aux_input_dim=2, task_heads=task_heads, task_losses=task_losses, in_dict_size=len(ds.token_mapping), padding_token=ds.token_mapping['PADDING_TOKEN'])
summary(model)
